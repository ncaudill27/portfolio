...
const CARBON = {
  ...
  useNotionElement: {
    src:
      "https://carbon.now.sh/embed?bg=rgba%28235%2C249%2C250%2C1%29&t=night-owl&wt=none&l=jsx&ds=false&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=0px&ph=0px&ln=false&fl=1&fm=Source+Code+Pro&fs=18px&lh=133%25&si=false&es=2x&wm=false&code=const%2520useNotionElement%2520%253D%2520blocks%2520%253D%253E%2520%257B%250A%2520%2520let%2520properties%252C%2520children%253B%250A%250A%2520%2520const%2520tagName%2520%253D%2520getTag%28blocks%29%253B%250A%250A%2520%2520if%2520%28blocks.type%2520%21%253D%253D%2520%2522text%2522%29%2520%257B%250A%2520%2520%2520%2520properties%2520%253D%2520handleProperties%28blocks%29%253B%250A%2520%2520%2520%2520children%2520%253D%2520generateChildren%28blocks%29%253B%250A%2520%2520%257D%250A%250A%2520%2520return%2520%257B%250A%2520%2520%2520%2520...blocks%252C%2520%252F%252F%2520spread%2520all%2520existing%2520block%2520properties%250A%2520%2520%2520%2520...properties%252C%2520%252F%252F%2520spread%2520updated%2520properties%250A%2520%2520%2520%2520tagName%252C%2520%252F%252F%2520overwrite%2520existing%2520blocks.tagName%250A%2520%2520%2520%2520children%2520%252F%252F%2520overwrite%2520existing%2520blocks.children%250A%2520%2520%257D%253B%250A%257D%253B"
  },
  factory: {
    src:
